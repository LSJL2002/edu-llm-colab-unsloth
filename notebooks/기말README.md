...
설명: 동일한 학생의 질문 프롬프트에 대해 베이스 모델과 파인튜닝 모델이 생성한 답변을 비교한 화면입니다. 파인튜닝 모델이 지시사항에 따른 교육적 페르소나를 훨씬 훌륭하게 구현하고 있음을 확인할 수 있습니다. 단 코드의 정확성이 떨어지고, 파인 튜닝을 한 모델은 한국어를 출력을 못하는 단점이 있습니다.
